...
> **致谢**：本项目由 [YSMull/fenbi-helper](https://github.com/YSMull/fenbi-helper) 改造而来，在原项目基础上扩展了词语频次统计、PDF 排版优化、页面返回逻辑、艾宾浩斯错题复习等功能。感谢原作者开源贡献。

国考 / 公考备考刷题辅助工具，基于粉笔网题库 API，提供练习记录分析、错题本整理、词语频次统计、艾宾浩斯错题复习、PDF 错题本导出等功能。本地部署，数据缓存于本地，保护隐私。
